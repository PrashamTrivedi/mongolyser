    ...
    <div className="relative p-4 sm:p-6 rounded-sm overflow-hidden max-w-sm">
      ...
      {actionSelected.type === "log" && (
        <>
          ...
          <input
            className="block p-2 w-full text-sm text-grey bg-white rounded-lg border border-indigo-300 cursor-pointer focus:outline-none"
            id="file_input"
            type="file"
            onChange={(e) => {
      ...
      {loader === true ? (
        ...
        <button
          ...
          className="p-2 btn bg-indigo-500 hover:bg-indigo-600 text-white mt-3"
        >
          Submit
        </button>
      )}
