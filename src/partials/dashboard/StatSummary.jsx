...
export default function StatSummary(props) {
  ...
  return (
    <div className="col-span-full bg-white dark:bg-table-dark shadow-lg rounded-md border border-slate-200 dark:border-slate-500  m-10">
      <header className="px-5 py-4 border-b-2 dark:border-slate-500 border-slate-100">
        ...
        { Object.keys(dataList).map((s) => {
          ...
          return (
            <div
              ...
              className={ "border border-slate-200 bg-white dark:bg-table-dark rounded-md overflow-hidden shadow-lg dark:border-slate-500 m-5" + width }
            >
