  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        show={dropdownOpen}
        tag="div"
        className="origin-top-right z-10 absolute top-full left-0 right-auto md:left-auto md:right-0 min-w-56 bg-white dark:bg-black border border-slate-200 dark:border-slate-800 pt-1.5 rounded shadow-lg overflow-hidden mt-1"
        ...
        <div ref={dropdown}>
          ...
          <div className="py-2 px-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
            <ul className="flex items-center justify-between">
              <li>
                <button className="btn-xs bg-white dark:bg-black border-slate-200 dark:border-slate-700 hover:border-slate-300 text-slate-500 dark:text-slate-400  hover:text-slate-600 dark:hover:text-slate-300">Clear</button>
              </li>
              <li>
